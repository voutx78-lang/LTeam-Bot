...
export default function App() {
  ...
  return <main className="app-shell">
    ...
    {false && tab === "create-order" && <OrderReferenceWidget />}
    ...
    {tab === "my-listings" && <MyListingsWorkspace fetchData={apiFetch} request={apiRequest} onNavigate={setTab} onOpenDeal={async (dealId) => { try { setDealItems(await apiFetch("/api/deals")); } catch {} setTab("orders"); setToast(`Сделка #${dealId} создана. Откройте её в разделе «Сделки».`); }} />}
